...
router.route('/:id').get(getCategory).put(ProtectedRoutes, allowedTo('admin'), uploadSingleFile('image', 'category'), updateCategory).delete(ProtectedRoutes, allowedTo('user'), deleteCategory)
